    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md glass-popup rounded-2xl shadow-2xl overflow-hidden"
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      doc.roundedRect(w - 50, 15, 30, 10, 3, 3, 'F');
                      doc.setFontSize(8);
                      doc.text('PAID', w - 41, 22);
                      ...
                      doc.setFontSize(16);
                      doc.text(`$${amount}.00`, w - 20, y, { align: 'right' });
                      ...
                      doc.text('This is a demo receipt generated by WebVision.', w / 2, y, { align: 'center' });
                      doc.text('Secured by Razorpay · 256-bit encryption (Demo Mode)', w / 2, y + 5, { align: 'center' });
                      
                      doc.save(`webvision-receipt-${txnId}.pdf`);
                    }}
                  >
